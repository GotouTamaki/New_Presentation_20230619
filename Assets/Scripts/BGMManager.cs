...
public class BGMManager : MonoBehaviour
{
    ...
    void OnActiveSceneChanged(Scene prevScene, Scene nextScene)
    {
        ...
        //ステージ選択からステージへ
        if (_beforeScene == "StageSelectScene" && (nextScene.name == "Stage_1" || nextScene.name == "Stage_2"))
        {
            _source.Stop();
        ...
        //ステージからタイトル、ステージ選択へ
        if ((_beforeScene == "Stage_Tutorial" || _beforeScene == "Stage_1" || _beforeScene == "Stage_2") && (nextScene.name == "TitleScene" || nextScene.name == "StageSelectScene"))
        {
            _source.Stop();
        ...
        //ステージからクリア画面へ
        if ((_beforeScene == "Stage_Tutorial" || _beforeScene == "Stage_1" || _beforeScene == "Stage_2") && nextScene.name == "ClearScene")
        {
            _source.Stop();
        }
